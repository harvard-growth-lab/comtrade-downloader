...
class ConcordanceTable:
    ...
    def _run_concordance(self) -> None:
        ...
        if (
            ...
            self.df.loc[
                self.df.classification_code.str.startswith() == "9999",
                self.classification_code,
            ] = "999999"
        ...
        if (
            ...
            self.df.loc[
                self.df.classification_code == "XXXXXX", self.target_classification_code
            ] = "XXXX"
        ...
        self.df = self.df.rename(
            column={self.target_classification_code: "commoditycode"}
        )
